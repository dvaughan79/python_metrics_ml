# -*- coding: utf-8 -*-
"""
Created on Tue Sep 08 2015
Arguments: Y: vector of dependent variable
           X: matrix of independent and continuous regressors
@author: a3940004
"""
...
# I now want a function that returns a yhat given and a tree:
def cart_yhat(Tree,Xmat):
    '''
    Arguments: 
    Tree: the Nodes resulting from calling cart_func()
    Xmat: The matrix that I want to predict
    '''
